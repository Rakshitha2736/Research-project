"""
Train temporal CNN-LSTM ablation h=1 (8 features, v2 data) — seed 42.
...
from src.model import CNNLSTMTemporalBaseline
...
def main() -> None:
    ...
    ckpt_path = MODELS / "cnn_lstm_temporal_h1_seed42.pt"
    torch.save(
        {
